...
public class CaseInsureNicotineUsage implements java.io.Serializable {
	...
	public CaseInsureNicotineUsage(CaseClientMap caseClientMap, Character nicotineUseInd, String nicotineTypeCd,
			String nicotineTypeOther, char isDeletedInd, String lstUpdtUserId, Date lstUpdtDtm,
			String nicotineLastUsedDate, Character nicotinePastAndQuitInd) {

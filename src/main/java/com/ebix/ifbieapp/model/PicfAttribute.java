...
public class PicfAttribute implements java.io.Serializable {
	...
	public PicfAttribute(PicfAttributeSet picfAttributeSet, String attrName, String attrDisplayName, String attrDesc,
			String attrDataType, String attrDefaultValue, String attrFieldType, String attrMaskType,
			String attrMinLength, String attrMaxLength, Date attrMinDate, Date attrMaxDate, String comboType,
			String entityName, String keyPropertyName, String valuePropertyName, Character readOnlyIndicator,
			Character visibleIndicator, BigDecimal tenantId, Date lastUpdatedDate, BigDecimal lastUpdatedUser,
			Byte isDeleted, Set<PicfAcrofields> picfAcrofieldses, Set<PicfAttributeValue> picfAttributeValues,
			Set<PicfAttrkvpair> picfAttrkvpairs) {

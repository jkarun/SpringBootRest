...
public class CaseClientQuestionResponse  implements java.io.Serializable {
    ...
    public CaseClientQuestionResponse(CaseClientQuestionResponseId id, CaseClientMap caseClientMap, int questionnaireId, char isDeletedInd, Date lstUpdtDtm) {
        this.id = id;
    ...
    public CaseClientQuestionResponse(CaseClientQuestionResponseId id, CaseClientMap caseClientMap, int questionnaireId, Integer responseIndex, String responseValue, char isDeletedInd, String lstUpdtUserId, Date lstUpdtDtm, String questionDesc) {
       this.id = id;
       this.caseClientMap = caseClientMap;
       this.questionnaireId = questionnaireId;

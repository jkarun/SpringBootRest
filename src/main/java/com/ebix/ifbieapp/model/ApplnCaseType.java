 ...
 */
@Entity
@Table(name="appln_case_type"
    ,schema="dbo"
    ,catalog="life_eapp"
    , uniqueConstraints = @UniqueConstraint(columnNames={"company_id", "case_typ_cd", "appln_case_type_cd"}) 
)
public class ApplnCaseType  implements java.io.Serializable {
    ...
    public ApplnCaseType(int id, Integer companyId, String caseTypCd, String applnCaseTypeCd, String caseTypeDesc, Character isDeletedInd, String lstUpdtUserId, Date lstUpdtDtm) {
       this.id = id;

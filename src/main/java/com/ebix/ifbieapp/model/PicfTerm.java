...
public class PicfTerm implements java.io.Serializable {
	...
	public PicfTerm(String name, String displayName, String description, String type, String mapping,
			BigDecimal lastUpdatedUser, Date lastUpdatedDate, Byte isDeleted, String datatype,
			Set<PicfAcrofields> picfAcrofieldses) {
		this.name = name;

...
public class PicfQueryDetails implements java.io.Serializable {
	...
	public PicfQueryDetails(String queryName, String queryString, String queryType, Byte cacheable,
			BigDecimal lastUpdatedUser, Date lastUpdatedDate, Byte isDeleted, BigDecimal userId,
			Set<PicfQueryLookup> picfQueryLookups) {
		this.queryName = queryName;

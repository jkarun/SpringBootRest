...
public class CaseClientInforceDetails implements java.io.Serializable {
	...
	public CaseClientInforceDetails(CaseClientMap caseClientMap, Character hasOtherPoliciesInforceInd,
			Character replaceInd, Integer numberOfPoliciesInforce, Character adbInforceInd, char isDeletedInd,
			String lstUpdtUserId, Date lstUpdtDtm, String adbAmt, Character haveOtherLifeInd,
			BigDecimal amountInforce) {

...
public class PortalpropertiesId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PortalpropertiesId) ) return false;
		 PortalpropertiesId castOther = ( PortalpropertiesId ) other; 
         
		 return ( (this.getPortalId()==castOther.getPortalId()) || ( this.getPortalId()!=null && castOther.getPortalId()!=null && this.getPortalId().equals(castOther.getPortalId()) ) )

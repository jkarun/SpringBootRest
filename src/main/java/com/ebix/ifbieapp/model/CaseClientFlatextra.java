...
public class CaseClientFlatextra implements java.io.Serializable {
	...
	public CaseClientFlatextra(CaseClientMap caseClientMap, BigDecimal flatextraValue, int flatextraYears,
			char flatextraFlag, char isDeletedInd, Date lstUpdtDtm) {
	...
	public CaseClientFlatextra(CaseClientMap caseClientMap, BigDecimal flatextraValue, int flatextraYears,
			char flatextraFlag, char isDeletedInd, String lstUpdtUserId, Date lstUpdtDtm) {
		this.caseClientMap = caseClientMap;
		this.flatextraValue = flatextraValue;
		this.flatextraYears = flatextraYears;
		this.flatextraFlag = flatextraFlag;

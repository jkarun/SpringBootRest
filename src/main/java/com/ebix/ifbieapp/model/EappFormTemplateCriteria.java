...
@Table(name = "eapp_form_template_criteria"
		...
		, uniqueConstraints = @UniqueConstraint(columnNames = { "company_id", "prod_typ_cd", "case_typ_cd",
				"state_cd" }))
...
public class EappFormTemplateCriteria implements java.io.Serializable {
	...
	public EappFormTemplateCriteria(int companyId, String prodTypCd, String caseTypCd, String stateCd,

...
public class BaseProducts  implements java.io.Serializable {
    ...
    public BaseProducts(int prodId, String prodCd, String prodNm, String prodTypCd, String lifeTypCd, Integer companyId, Character isActive, Character isPublished, Character isDeletedInd, Date lstUpdtDtm, String lstUpdtUserId) {
       this.prodId = prodId;
       this.prodCd = prodCd;
       this.prodNm = prodNm;

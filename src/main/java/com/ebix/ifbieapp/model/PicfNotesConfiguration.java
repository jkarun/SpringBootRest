...
public class PicfNotesConfiguration  implements java.io.Serializable {
    ...
    public PicfNotesConfiguration(String pageName, byte showCategory, byte showSubCategory, byte showAccessTypes, String noteLabel, byte showAttachments, byte showGridEditButton, byte showSubCategoryFilter) {
    ...
    public PicfNotesConfiguration(String pageName, String description, byte showCategory, String category, byte showSubCategory, String subCategory, byte showAccessTypes, String accessTypes, String defaultAccessType, String noteLabel, Integer noteWidth, byte showAttachments, byte showGridEditButton, byte showSubCategoryFilter, BigDecimal lastUpdatedUser, Date lastUpdatedDate, Byte isDeleted) {
       this.pageName = pageName;

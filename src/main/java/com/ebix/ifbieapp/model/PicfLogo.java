...
/**
 * PicfLogo generated by hbm2java
 */
@Entity
@Table(name="picf_logo"
    ,schema="dbo"
    ,catalog="life_eapp"
)
public class PicfLogo  implements java.io.Serializable {
    ...
    public PicfLogo(BigDecimal tenantId, String logoPath) {
        this.tenantId = tenantId;
        this.logoPath = logoPath;
    }
    public PicfLogo(BigDecimal tenantId, String logoPath, Date lastUpdatedDate, BigDecimal lastUpdatedUser, Byte isDeleted) {
       this.tenantId = tenantId;
       this.logoPath = logoPath;

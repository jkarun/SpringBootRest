...
@Table(name = "dyna_ui_mapping"
		...
		, uniqueConstraints = @UniqueConstraint(columnNames = { "screen_id", "ui_element_id",
...
public class DynaUiMapping implements java.io.Serializable {
	...
	public DynaUiMapping(DynaUiElements dynaUiElements, DynaUiScreen dynaUiScreen,
			ProductCombination productCombination, char visibleInd, char mandatoryInd, char editableInd,
	...
	public DynaUiMapping(DynaUiElements dynaUiElements, DynaUiScreen dynaUiScreen,
			ProductCombination productCombination, char visibleInd, char mandatoryInd, char editableInd,
			String defaultValueTxt, char isDeletedInd, String lstUpdtUserId, Date lstUpdtDtm) {
		this.dynaUiElements = dynaUiElements;
		this.dynaUiScreen = dynaUiScreen;
		this.productCombination = productCombination;
		this.visibleInd = visibleInd;

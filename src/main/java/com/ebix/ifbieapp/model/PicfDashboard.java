...
public class PicfDashboard implements java.io.Serializable {
	...
	public PicfDashboard(String name, String description, String soureType, String query, String countQuery,
			String entity, Integer recordsPerPage, String selectionModel, Character filtering, String status,
			String emptyText, BigDecimal lastUpdatedUser, Date lastUpdatedDate, Byte isDeleted,
			Set<PicfColumnMetadata> picfColumnMetadatas) {
		this.name = name;

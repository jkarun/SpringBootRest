...
public class Company  implements java.io.Serializable {
    ...
    public Company(int companyId, String companyCd, String companyNm, Integer archivingDays, String archivingPath, char isDeletedInd, String lstUpdtUserId, Date lstUpdtDtm, Integer parentCompanyId, Character setupAllowInd) {
       this.companyId = companyId;
       this.companyCd = companyCd;
       this.companyNm = companyNm;

...
public class PicfTriggerDetail implements java.io.Serializable {
	...
	public PicfTriggerDetail(PicfJobDetail picfJobDetail, String name, String groupName, String type, String daysOfWeek,
	...
	public PicfTriggerDetail(PicfJobDetail picfJobDetail, String name, String description, String groupName,
			String type, Date startTime, Date endTime, BigDecimal repeatInterval, Integer repeatCount, Integer hour,
			Integer minute, String daysOfWeek, String cronExpression, BigDecimal lastUpdatedUser, Date lastUpdatedDate,
			Byte isDeleted) {
		this.picfJobDetail = picfJobDetail;
		this.name = name;
